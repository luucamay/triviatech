...
playHTML.addEventListener("click", function (){openQuiz('js')});
playCSS.addEventListener("click", function (){openQuiz('css')});

answerJS11.addEventListener("click", function(){wrongAnswer(answerJS11, answerJS12)});
answerJS12.addEventListener("click", function(){rightAnswer(answerJS12, answersBoxJS1, answersBoxJS2)});
answerJS13.addEventListener("click", function(){wrongAnswer(answerJS13, answerJS12)});
answerJS14.addEventListener("click", function(){wrongAnswer(answerJS14, answerJS12)});

answerJS21.addEventListener("click", function(){rightAnswer(answerJS21, answersBoxJS2, answersBoxJS3)});
answerJS22.addEventListener("click", function(){wrongAnswer(answerJS22, answerJS21)});
answerJS23.addEventListener("click", function(){wrongAnswer(answerJS23, answerJS21)});
answerJS24.addEventListener("click", function(){wrongAnswer(answerJS24, answerJS21)});

answerJS31.addEventListener("click", function(){wrongAnswer(answerJS31, answerJS31)});
answerJS32.addEventListener("click", function(){wrongAnswer(answerJS32, answerJS31)});
answerJS33.addEventListener("click", function(){rightAnswer(answerJS33, answersBoxJS3, 'final')});
answerJS34.addEventListener("click", function(){wrongAnswer(answerJS34, answerJS31)});

answerCSS11.addEventListener("click", function(){wrongAnswer(answerCSS12, answerCSS14)});
answerCSS12.addEventListener("click", function(){wrongAnswer(answerCSS12, answerCSS14)});
answerCSS13.addEventListener("click", function(){wrongAnswer(answerCSS13, answerCSS14)});
answerCSS14.addEventListener("click", function(){rightAnswer(answerCSS14, answersBoxCSS1, answersBoxCSS2)});

answerCSS21.addEventListener("click", function(){wrongAnswer(answerCSS21, answerCSS22)});
answerCSS22.addEventListener("click", function(){rightAnswer(answerCSS22, answersBoxCSS2, answersBoxCSS3)});
answerCSS23.addEventListener("click", function(){wrongAnswer(answerCSS23, answerCSS22)});
answerCSS24.addEventListener("click", function(){wrongAnswer(answerCSS24, answerCSS22)});

answerCSS31.addEventListener("click", function(){wrongAnswer(answerCSS31, answerCSS33)});
answerCSS32.addEventListener("click", function(){wrongAnswer(answerCSS32, answerCSS33)});
answerCSS33.addEventListener("click", function(){rightAnswer(answerCSS33, answersBoxCSS3, 'final')});
answerCSS34.addEventListener("click", function(){wrongAnswer(answerCSS34, answerCSS33)});
